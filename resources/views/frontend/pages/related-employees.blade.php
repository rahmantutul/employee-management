             ...
             @foreach ($employees as $employee)
                 <div class="col-md-4 col-sm-4 col-xs-12 text-xs-center wow fadeInDown">
                    <div class="service-box">
                        ...
                        <span style="font-weight: 600">Join: {{ date('Y-m-d', strtotime($employee['created_at']))}}</span><br> 
                        ...
                        <span style="font-weight: 600">Make Report: <a href="{{ url('/report') }}" target="_blank" rel="noopener noreferrer">Report</a></span>
